...
- 实时功率趋势图动态展示设备响应
- 碳减排估算与环境效益展示
- **平滑评分优化**：基于脉冲幅值的相对误差评分，满分100分，直观反映平滑效果
...
class HESSGUI:
    ...
    def show_results(self, hess, res, amp, dur, selected):
        ...
        # 评分公式：100 * (1 - rmse / pulse_amp)，但限制在0~100之间
    ...
    def plot_all(self, hess, res):
        ...
        try:
            ...
            plt.title('脉冲平滑效果对比 (高度重合)', fontsize=12)
            ...
            plt.title('各设备电流变化 (超强滤波, 无跳变)', fontsize=12)
            ...
            plt.title('各设备电压变化 (超强滤波, 无跳变)', fontsize=12)
            plt.legend(fontsize=7)
            plt.grid(True, alpha=0.3)
            ...
            if sc:
                ...
                plt.ylabel('电压 (V)', fontsize=10)
                plt.title('超级电容器能量-电压关系', fontsize=12)
            ...
            if bess:
                ...
                plt.title('锂电池储能能量-电流关系', fontsize=12)
                plt.colorbar(label='时间 (秒)')
                plt.grid(True, alpha=0.3)
            else:
            ...
            if fess:
                ...
                plt.xlabel('储存能量 (kWh)', fontsize=10)
                plt.ylabel('电压 (V)', fontsize=10)
                plt.title('飞轮储能能量-电压关系', fontsize=12)
                plt.colorbar(label='时间 (秒)')
                plt.grid(True, alpha=0.3)
            else:
            ...
            if smes:
                ...
                plt.xlabel('储存能量 (kWh)', fontsize=10)
                plt.ylabel('电流 (A)', fontsize=10)
                plt.title('超导磁储能能量-电流关系', fontsize=12)
                plt.colorbar(label='时间 (秒)')
                plt.grid(True, alpha=0.3)
            else:
            ...
            if caes:
                ...
                plt.xlabel('储存能量 (kWh)', fontsize=10)
                plt.ylabel('电压 (V)', fontsize=10)
                plt.title('压缩空气储能能量-电压关系', fontsize=12)
                plt.colorbar(label='时间 (秒)')
                plt.grid(True, alpha=0.3)
            else:
